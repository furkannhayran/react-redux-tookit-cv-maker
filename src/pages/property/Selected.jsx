        ...
        <div className='selected-container'>
            <div className='selected-container-navbar'>
                ...
                <div className='selected-container-navbar-content'>
                    <select onChange={(e) =>handleSelect(e)} className='selected-container-navbar-content-one-select'>
                        {onemoon.map((item, i) => (
            ...
            <div className='selected-container-navbar-two'>
                ...
                <div className='selected-container-navbar-content-two' >
                    <select onSelect={handleSelect} className='selected-container-two-navbar-content-one-select'>
                        {twomoon.map((item, i) => (
                            <option key={i}>{item.moon}</option>
                        ))}
                    </select>
